...
switch toplay{
	case "news-test.mp4":
		/*
			...
			event-frame array, and note the event the the event array. Not
			exactly a streamlined process but what the hell am I supposed to do
			about it. Also make sure you add a noone to the end of the event_frame
			array so that the next_event isn't outside the array's index.
		*/
		event_frame=[202,277,349,noone];
		event=["cam","img","snd"];
	break;
